...
for required in ['CanonicalConversationPolicy.java','CanonicalChatRoutingPolicy.java','AdaptiveNavigationPlanner.java','TransportState.java','SessionMaterial.java','MaterialHandoffPolicy.java']:
