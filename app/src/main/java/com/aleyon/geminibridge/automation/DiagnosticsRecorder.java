...
/** Bounded best-effort diagnostic ring buffer; diagnostics never alter automation behaviour. */
public final class DiagnosticsRecorder {
    ...
    public DiagnosticsRecorder(Context context) { prefs = context.getSharedPreferences(PREFS, Context.MODE_PRIVATE); }
    ...
    public String recentJson() { return prefs.getString(KEY_RECENT, "[]"); }
}
